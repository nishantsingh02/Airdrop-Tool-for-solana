    ...
    return <div className="">
       ...
       <div>
        ...
        <div className="flex items-center justify-between bg-gray-100 p-2 mt-1 rounded-md">
          <span className="font-mono text-sm text-gray-800">{shortAddress}</span>
          <button onClick={handleCopy} className="p-1 rounded-md hover:bg-gray-200">
            {copied ? <span className="text-xs text-green-600">Copied!</span> : <CopyIcon />}
          </button>
        </div>
      </div>
