...
export function Airdrop() {
    ...
    return <div className="">
        <p className="text-gray-700 text-sm md:text-base font-medium bg-gray-100 p-2 rounded-md shadow-sm">
  hi User, This is your Public Key {wallet.publicKey?.toString()}
</p>
